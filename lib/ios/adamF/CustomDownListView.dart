...
typedef void ChangeData(Map<String, dynamic> map, Map<String, dynamic> map1,
...
class CityPicker {
  static void showCityPicker(
    ...
    int cancelColor, // 取消文字颜色
    int sureColor, // 确定文字颜色
  }) {
    rootBundle.loadString('data/province.json').then((v) {
      ...
      Navigator.push(
        ...
        new _CityPickerRoute(
            cancelColor: cancelColor = 0xff9a9a9a,
            sureColor: sureColor = 0xff365AF7,
            data: data,
                ...
                children: <Widget>[
                  FlatButton(
                    ...
                    child: new Text(
                      ...
                      style: new TextStyle(
                        ...
                        color: Color(widget.cancelColor),
                        fontSize: 16.5,
                  ...
                  FlatButton(
                    onPressed: () {
                      ...
                      // }
                      if (widget.selectProvince != null) {
                        widget.selectProvince(provinceMap, cityMap, areaMap);
                      }
